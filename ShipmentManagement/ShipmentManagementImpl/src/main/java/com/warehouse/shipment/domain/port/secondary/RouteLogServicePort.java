...
public interface RouteLogServicePort {
    Result<RouteProcess, ErrorCode> notifyShipmentCreated(final ShipmentId shipmentId, final SoftwareConfiguration softwareConfiguration, final UserId createdBy);
