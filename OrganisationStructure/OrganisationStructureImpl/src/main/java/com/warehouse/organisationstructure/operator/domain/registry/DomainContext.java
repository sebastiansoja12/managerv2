package com.warehouse.organisationstructure.operator.domain.registry;
...
@Component("organisationstructure.domainContext")
public final class DomainContext implements ApplicationEventPublisherAware, ApplicationContextAware {
    ...
    public static synchronized OperatorService operatorService() {
        return context.getBean(OperatorService.class);
    }

    public static synchronized OperatorConfigurationService operatorConfigurationService() {
        return context.getBean(OperatorConfigurationService.class);
    }
        ...
        if (DomainContext.eventPublisher == null) {
            synchronized (DomainContext.class) {
                if (DomainContext.eventPublisher == null) {
                    ...
                    log.info("ApplicationEventPublisher initialized in OrganisationStructure DomainContext");
                }
            }
        }
    }
