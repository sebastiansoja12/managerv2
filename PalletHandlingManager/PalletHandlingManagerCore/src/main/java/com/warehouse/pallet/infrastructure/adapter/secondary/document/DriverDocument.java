...
public class DriverDocument {
    ...
    public static DriverDocument from(final Driver driver) {
        final DriverDocument driverDocument;
        if (driver == null) {
            driverDocument = DriverDocument.empty();
        } else {
            driverDocument = new DriverDocument(driver.getDriverId(), driver.getFirstName(), driver.getLastName(),
                    driver.getAssignedDepartments(), driver.getAssignedTrucks());
        }
        return driverDocument;
    }

    private static DriverDocument empty() {
